    ...
    createLightSection() {
        ...
        const dirLightDiv = this.createSlider(
            ...
            (value) => {
                ...
                if (this.game.trackBuilder && this.game.trackBuilder.directionalLight) {
                    this.game.trackBuilder.directionalLight.intensity = value;
                }
            }
        );
        ...
        const ambLightDiv = this.createSlider(
            ...
            (value) => {
                ...
                if (this.game.trackBuilder && this.game.trackBuilder.ambientLight) {
                    this.game.trackBuilder.ambientLight.intensity = value;
                }
            }
        );
